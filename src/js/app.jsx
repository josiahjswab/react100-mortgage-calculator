...
export default class App extends React.Component {
  ...
  changeInput(object) {
    // in online examples object is listed as event and wanted to see
    // if the code would break if I changed it.
    // As long as the same var name appears as a parameter in the
    // function it seems to work just fine.
